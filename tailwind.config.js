  ...
  theme: {
    extend: {
      colors: {
        ...
        'dark-base': '#060602',     // replaces #02021E — outermost dark backgrounds
        'dark-surface': '#0E0E0E',  // replaces #0D0D2E — card / inner dark surfaces
        primary: {
          50: '#eff6ff',
          100: '#dbeafe',
          200: '#bfdbfe',
      ...
      fontFamily: {
        sans: ['Mazzard', 'system-ui', 'sans-serif'],
        display: ['Mazzard', 'system-ui', 'sans-serif'],
      },
      animation: {

                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 h-full">
                        ...
                        <div className="space-y-8 flex flex-col">
                            ...
                            <div className="flex items-center space-x-3">
                                ...
                                <h3 className="text-lg font-medium text-gray-900">Who we are</h3>
                            </div>
                        ...
                        <div className="space-y-8">
                            ...
                            >
                                ...
                                <p>
                                    Our mission is to turn ideas into strategic, visual solutions that resonate deeply and support our clients' goals.
                                </p>
                            </motion.div>
                            ...
                            >
                                <button className="bg-gray-900 hover:bg-gray-800 text-white font-medium py-4 px-8 rounded-xl transition-all duration-300 flex items-center space-x-3 group">
                                    <span>About us</span>

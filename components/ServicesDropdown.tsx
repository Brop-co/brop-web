...
const DropdownItem = ({ item, isDark }: { item: any; isDark: boolean }) => {
  ...
  return (
    ...
    >
      ...
      >
        <div className={`w-14 h-14 rounded-2xl flex items-center justify-center flex-shrink-0 shadow-sm border mb-4 ${
          isDark ? "bg-white/10 border-white/10" : "bg-white border-gray-100/50"
        }`}>
          <item.icon
            ref={iconRef}
            size={24}
  ...
  return (
    ...
    >
      <motion.div
        ...
        className={`max-w-6xl mx-auto rounded-[40px] p-6 lg:p-10 shadow-sm backdrop-blur-xl border ${
          isDark

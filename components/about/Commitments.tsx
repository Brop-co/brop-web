  ...
  return (
    ...
    >
      <div className="max-w-[1460px] mx-auto">
        ...
        >
          <h3 className="text-3xl sm:text-5xl lg:text-6xl font-[600] text-gray-900 dark:text-white leading-snug sm:leading-tight w-full md:w-[30%] mb-8">
          ...
          {commitmentsData.map((item) => (
            ...
            >
              ...
              <div className="flex items-center gap-3 lg:w-[50%]">
                <span className="flex-none text-xl text-gray-900 dark:text-white pt-1 lg:w-[5%] font-semibold lg:font-normal">
                  {item.id}
                </span>
                <p className="text-xl font-semibold lg:font-normal sm:text-3xl text-gray-900 dark:text-white lg:w-[90%]">
                  {item.title}
                </p>
              </div>

              {/* Description */}
              <p className="text-gray-900 dark:text-white/70 text-lg sm:text-xl lg:text-3xl leading-relaxed lg:flex-1">
                {item.description}
              </p>
            </motion.div>
          ))}

...
const Projects = () => {
  ...
  const [hoveredProject, setHoveredProject] = useState<ProjectProps | null>(
    null
  );
    ...
    >
      <div className="max-w-[1460px] mx-auto">
        ...
        >
          ...
          <div className="flex items-end justify-start gap-2 sm:gap-0 sm:justify-end">
            <button
          ...
          >
            {filtered.map((p, idx) => (
              <motion.div
                ...
                className="group"
                ref={(el) => {
                  if (el) itemRefs.current[p.title] = el;
                }}

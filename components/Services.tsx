                ...
                >
                    ...
                    >
                        ...
                        <div className="flex items-center space-x-3">
                            ...
                            <h2 className="text-2xl font-medium text-gray-900">Our services</h2>
                        </div>
                    ...
                    <div className="space-y-0">
                        {services.map((service, index) => (
                            ...
                            >
                                ...
                                <motion.div
                                    className="absolute inset-0 bg-gray-50 origin-center"
                                    initial={{ scale: 0 }}
                                    whileHover={{ scale: 1 }}
                                ...
                                <div className="flex-1 flex items-center justify-between relative z-10 ml-4">
                                    ...
                                    <motion.div
                                        ...
                                        className="ml-4"
                                    >
                                        <ArrowRight size={20} className="text-gray-900 group-hover:text-blue-600 transition-colors duration-200" />
                                    </motion.div>
                                </div>
                            </motion.div>
                        ))}
